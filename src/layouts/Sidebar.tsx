  ...
  return (
    <div className='h-full w-full text-white'>
      ...
      <div className='flex flex-col' style={{ gap: '20px' }}>
        <div className='flex items-center border bg-black' style={{ width: '50%', backgroundColor: 'rgba(0, 195, 202, 0.3)', borderColor: 'rgb(0, 195, 202)' }} onClick={() => handleRedirect('/chat')}>
          {/* 左側の画像コンテナ */}
        ...
        <div className='flex items-center border bg-black' style={{ width: '50%', backgroundColor: 'rgba(157, 180, 255, 0.3)', borderColor: 'rgb(157, 180, 255)' }} onClick={() => handleRedirect('/voice-chat')}>
          {/* 左側の画像コンテナ */}
        ...
        <div className='flex items-center border bg-black' style={{ width: '50%', backgroundColor: 'rgba(74, 218, 156, 0.3)', borderColor: 'rgb(74, 218, 156)' }} onClick={() => handleRedirect('/bot')}>
          {/* 左側の画像コンテナ */}

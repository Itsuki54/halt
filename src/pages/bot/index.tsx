      ...
      <div className='max-w-4xl mx-auto p-6 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-lg shadow-lg'>
        ...
        <div className='bg-white p-6 rounded-lg shadow-md mb-6'>
          ...
          <p className='text-lg text-gray-700'>
            <strong>Gender:</strong> {bot.gender}
          </p>
          <p className='text-lg text-gray-700'>
            <strong>Purpose:</strong> {bot.purpose}
          </p>
          <p className='text-lg text-gray-700'>
            <strong>Character:</strong> {bot.character}
          </p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <div className='mb-4'>
            ...
            >
              ...
              {purposeList.map((purpose, index) => <option key={index} value={purpose}>{purpose}</option>)}
            </select>
          ...
          <div className='mb-4'>
            ...
            >
              ...
              {characterList.map((character, index) => <option key={index} value={character}>{character}</option>)}
            </select>
